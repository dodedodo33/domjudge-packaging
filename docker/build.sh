...
docker build -t registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/judgehost:${VERSION}-build -f judgehost/Dockerfile.build .
docker rm -f domjudge-judgehost-${VERSION}-build > /dev/null 2>&1 || true
docker run -it --name domjudge-judgehost-${VERSION}-build --privileged registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/judgehost:${VERSION}-build
...
docker rmi registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/judgehost:${VERSION}-build
...
echo "$ docker push registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/domserver:${VERSION} && docker push registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/judgehost:${VERSION} && docker push registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/default-judgehost-chroot:${VERSION}"
...
docker push registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/domserver:latest && docker push registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/judgehost:latest && docker push registry.dj33.nl/error418/hbo-i_apc/domjudge-packaging/default-judgehost-chroot:latest"
